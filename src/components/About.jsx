...
export const About = () => {
  return (
    <div id='About' className='text-white mb-14'>
      <h2 className='flex flex-wrap justify-center items-center gap-1 text-3xl md:text-4xl mt-8 font-semibold'><IoMdContact className=' text-cyan-400 text-4xl md:text-5xl '/> About Me</h2>
      <div className='w-11/12 mx-auto mt-6 text-white text-[1rem] md:text-lg xl:text-xl px-2 md:px-0 text-wrap text-justify tracking-tighter md:tracking-tight  xl:w-[75%]'>
        <p>Hello! I'm <span className='text-xl md:text-2xl xl:text-3xl text-cyan-400'>Abhinav Sharma</span> , a passionate web developer with a strong enthusiasm for creating dynamic and user-friendly web applications. As a final-year Information Technology student at Thakur College of Engineering and Technology, Mumbai, I have honed my skills in both frontend and backend development. My expertise includes HTML, CSS, JavaScript, React, Redux Toolkit, Node.js, Express.js, and MongoDB. I am dedicated to building responsive designs and ensuring cross-browser compatibility, always striving to optimize performance and user experience.</p> 
