...
export const Home = () => {
  return (
    ...
    <div className='text-white text-center lg:text-start w-[90%]  xs:w-[87%] sm:w-[77%] md:w-[80%] mx-auto lg:mx-0 lg:w-[47%] xl:w-[51%] text-[2rem] lg:text-[3.5rem] self-start pt-10'>
